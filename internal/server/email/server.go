...
import (
	...
	mailGrpc "github.com/JIeeiroSst/go-app/internal/email/delivery/grpc"
	"github.com/JIeeiroSst/go-app/internal/email/delivery/rabbitmq"
	"github.com/JIeeiroSst/go-app/internal/email/mailer"
	emailService "github.com/JIeeiroSst/go-app/internal/email/proto"
	"github.com/JIeeiroSst/go-app/internal/email/repository"
	"github.com/JIeeiroSst/go-app/internal/email/usecase"
	"github.com/JIeeiroSst/go-app/internal/interceptors"
...
func NewEmailsServer(amqpConn *amqp.Connection, logger logger.Logger, cfg *config.Config, mailDialer *gomail.Dialer, db *gorm.DB) *Server {
...
func (s *Server) Run() error {
	...
	emailRepository := repository.NewEmailRepository(s.db)
